...
const PrivacyPolicyPage = () => {
  ...
  useEffect(() => {
    PoPoAxios.get('/setting').then((res) => setSTUEmail(res.data.stuEmail));
  }, []);
  ...
  return (
    <Layout>
      ...
      <p>
        ...
        <br />
        <br />
        학생회는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는
        개별공지)을 통하여 공지할 것입니다.
        <br />
        <br />○ 본 방침은 2019년 10월 13일부터 시행됩니다.
      </p>
      <br />
      <p>
        ...
        <br />
        <br />
        학생회는 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는
      ...
      <p>
        ...
        유지·관리, 서비스 부정이용 방지, 고충처리 등을 목적으로 개인정보를
        처리합니다.
      </p>
      <p>
        나. 민원사무 처리
      ...
      <p>
        ...
        <br />
        <br />
        학생회는 회원가입 시점부터 아래의 개인정보 중 일부를 수집합니다. 단,
        회원이 각 항목에 해당되지 않을 경우, 해당 항목의 개인정보는 수집하지
        않습니다.
      </p>
      <ol>
        <li>
          <p>
            회원이 회원가입 또는 본인확인을 할 경우
            <br />- 아이디, 비밀번호, 이름, 이메일, 직책
          </p>
        </li>
        <li>
          <p>
            회원이 서비스를 이용하는 경우
            <br />- IP 주소, 쿠키, 방문일시, 서비스 이용기록
          </p>
        </li>
      </ol>
      <br />
      ...
      <p>
        ① 학생회는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
      ...
      <p>
        ...
        동의일로부터 회원 탈퇴 시까지 위 이용목적을 위하여 보유.이용됩니다.
        <br />
        -보유근거 : 회원가입 시 약관 동의
        <br />
        -예외사유 : 관계 법령 위반에 따른 수사․조사 등이 진행중인 경우에는 해당
        수사․조사 종료시까지, 학번 정보의 경우 회원 제재 중 탈퇴 시 부정 가입
        방지를 위해 탈퇴 이후 최대 1년까지 보유
      </p>
      <p>
        2. &lt;민원사무 처리&gt;
        <br />
        &lt;민원사무 처리&gt;와 관련한 개인정보는 수집.이용에 관한 동의일로부터
        민원사무 처리 완료 시까지 위 이용목적을 위하여 보유.이용됩니다.
        <br />
        -보유근거 : 회원가입 시 약관 동의
      </p>
      <br />
      <p>
        ...
        <br />
        <br />
        ① 학생회는 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조
        및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.
        <br />
        ② 학생회는 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
        <br />
        - 개인정보를 제공받는 자 : (학) 포항공과대학교
        <br />
        - 제공받는 자의 개인정보 이용목적 : 이름, 직책
        <br />
        - 제공받는 자의 보유.이용기간: 민원사항 처리 완료 시까지
        <br />※ 민원사항 처리를 위해 반드시 필요하다고 판단될 경우에만
      ...
      <p>
        ...
        <br />
        ① 정보주체는 학생회에 대해 언제든지 개인정보 열람,정정,삭제,처리정지
        요구 등의 권리를 행사할 수 있습니다.
        <br />
        ② 제1항에 따른 권리 행사는 학생회에 대해 개인정보 보호법 시행령
        제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
        있으며 학생회는 이에 대해 지체 없이 조치하겠습니다.
        <br />
        ...
        <br />⑥ 학생회는 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
      ...
      <p>
        ...
        <br />
        <br />
        ① 학생회는 다음의 개인정보 항목을 처리하고 있습니다.
        <br />
        1. &lt;홈페이지 회원가입 및 관리&gt;
        <br />
        - 필수항목 : 비밀번호, 로그인ID, 이름, 서비스 이용 기록, 접속 로그,
        쿠키, 접속 IP 정보
        <br />
      </p>
      <p>
      ...
      <p>
        ...
        <br />
        <br />
        학생회는 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당
      ...
      <p>
        ...
        <br />
        <br />① 학생회는 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
        수시로 불러오는 ‘쿠키(cookie)’를 사용합니다. ② 쿠키는 웹사이트를
        운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에게 보내는
        소량의 정보이며 이용자들의 PC 컴퓨터 내의 하드디스크에 저장되기도
        합니다. 가. 쿠키의 사용 목적 : 이용자가 방문한 각 서비스와 웹 사이트들에
        대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여
        이용자에게 최적화된 정보 제공을 위해 사용됩니다. 나. 쿠키의 설치•운영 및
        거부 : 웹브라우저 상단의 도구&gt;인터넷 옵션&gt;개인정보 메뉴의 옵션
        설정을 통해 쿠키 저장을 거부할 수 있습니다. 다. 쿠키 저장을 거부할 경우
      ...
      <p>
        ...
        <br />
        <br />① 학생회는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
      ...
      <p>
        ② 정보주체께서는 학생회의 서비스(또는 사업)을 이용하시면서 발생한 모든
        개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
        보호책임자 및 담당부서로 문의하실 수 있습니다. 학생회는 정보주체의
      ...
      <p>
        ...
        <br />
        <br />
        학생회는 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한
      ...
      <p>
        2. 개인정보의 암호화
        <br />
        이용자의 비밀번호는 단방향 암호화 되어 저장 및 관리되고 있어 본인만이 알
        수 있으며, 암호화된 비밀번호를 탈취하더라도 평문으로 된 비밀번호를 알 수
        없습니다.
      </p>
    </Layout>
  );
